...
import io.github.aktomik.redclocktower.command.TestCommand;
...
public final class RedClocktower extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        BrigadierToolbox.loadCommands(this,
            List.of(new StorytellerCommand(), new SetupCommand(), new VoteCommand(), new TagmeCommand(), new BroadcastCommand(), new TestCommand())
        );
